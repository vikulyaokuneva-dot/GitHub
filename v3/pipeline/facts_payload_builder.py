...
def build_territorial_distribution_summary(territorial_summary: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "unknown_share_pct": float(safe_summary.get("unknown_share_pct", 0.0) or 0.0),
        "known_localization_skus": int(safe_summary.get("known_localization_skus", 0) or 0),
        "unknown_localization_skus": int(safe_summary.get("unknown_localization_skus", 0) or 0),
        "full_analysis_skus": int(safe_summary.get("full_analysis_skus", 0) or 0),
        "preview_analysis_skus": int(safe_summary.get("preview_analysis_skus", 0) or 0),
        "disabled_analysis_skus": int(safe_summary.get("disabled_analysis_skus", 0) or 0),
        "usable_analysis_skus": int(safe_summary.get("usable_analysis_skus", 0) or 0),
        "blocked_analysis_skus": int(safe_summary.get("blocked_analysis_skus", 0) or 0),
