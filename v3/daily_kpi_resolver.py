...
def resolve_daily_kpi(
    ...
    supplier_orders_count_raw = int(_safe_float(supplier_goods_daily.get("orders_count", 0))) if supplier_found else 0
    supplier_buyouts_count_raw = int(_safe_float(supplier_goods_daily.get("buyouts_count", 0))) if supplier_found else 0
    supplier_orders_amount_raw = round(_safe_float(supplier_goods_daily.get("orders_amount", 0.0)), 2) if supplier_found else 0.0
    supplier_buyouts_amount_raw = round(_safe_float(supplier_goods_daily.get("buyouts_amount", 0.0)), 2) if supplier_found else 0.0
