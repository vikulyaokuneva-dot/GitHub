    ...
    diagnostics.update(
        {
            ...
            "realization_rows_count": financial.realization_rows_count,
            "realization_extraction_mode": financial.realization_extraction_mode,
            "realization_detected_operations": list(financial.realization_detected_operations),
            ...
            "funnel_compat_used": diagnostics.get("funnel_compat_used"),
            "funnel_payload_shape": diagnostics.get("funnel_payload_shape"),
            "funnel_payload_origin": diagnostics.get("funnel_payload_origin"),
            "funnel_extraction_mode": diagnostics.get("funnel_extraction_mode"),
