...
class TestMetricsBundleWithFunnel(unittest.TestCase):
    def test_engine_builds_financial_daily_and_funnel(self) -> None:
        context = RunContext(
        ...
        normalized = NormalizedBundle(
            ...
            realization=[NormalizedRealizationRecord("r1", None, 1, "2026-03-15", "sale", 90.0, 1.0, "realization", None, "Продажа")],
            funnel=[NormalizedFunnelRecord(1, "2026-03-15", 100.0, 50.0, 25.0, 10.0, 5.0, "funnel", "f1")],
            source_statuses={
        ...
        self.assertIn("funnel_records_count", metrics.diagnostics)
        self.assertIn("funnel_warnings_count", metrics.diagnostics)
