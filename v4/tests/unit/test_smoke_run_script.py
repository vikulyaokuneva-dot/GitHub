...
from v4.scripts.smoke_run_daily import run_smoke


class TestSmokeRunScript(unittest.TestCase):
    def test_smoke_run_ok_with_output_dir(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("v4.scripts.smoke_run_daily.run_daily_pipeline", return_value=fake_result):
                code = run_smoke(
    ...
    def test_smoke_run_detects_outside_output_dir(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir, tempfile.TemporaryDirectory() as outdir:
            ...
            fake_result = {
                ...
                "facts": {},
                "decisions": {},
                "outputs": {"artifacts": {"saved_files": {"facts": str(outside)}}},
                "warnings": [],
            }
            with patch("v4.scripts.smoke_run_daily.run_daily_pipeline", return_value=fake_result):
                code = run_smoke(
